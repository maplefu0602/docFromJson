...
class PandocConverter:
	...
	print kwargs.get('config_file', 'mkdocs.yml');
	...
	if self.config.has_key('markdown_extensions'):
       	    for ext in self.config.get('markdown_extensions'):
                extname = ''
    ...
    def convert(self):
        ...
        for page in pages:
            ...
            f_image = mkdocs_pandoc.filters.images.ImageFilter(
                    filename=page['file'],
                    image_path=self.config['docs_dir'],
